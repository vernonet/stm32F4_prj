...
#endif
//  NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 1;  //HAL_NVIC_SetPriority(OTG_FS_IRQn, 6, 0);
//  NVIC_InitStructure.NVIC_IRQChannelSubPriority = 3;
	NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 0;  //HAL_NVIC_SetPriority(OTG_FS_IRQn, 6, 0);
